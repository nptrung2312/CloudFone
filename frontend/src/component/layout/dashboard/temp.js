...
import { months, weekDays, listJob, ArrStatusJob, ArrColorStatus, ArrDepartment, jobData } from '../../elements/GlobalValiable';
            ...
            <div className='filter-tabs-wrapper'>
                <div className='filter-wrap'>
                    ...
                    <Tippy content="Thêm mới" placement="right">
                        <button className='btn-add-work' onClick={() => setOpenPanel(true)}><i className="fa fa-plus" aria-hidden="true"></i></button>
                    </Tippy>
                    <SlidingPanel
                        type={'right'}
                        isOpen={openPanel}
                                            ...
                                            <tbody>
                                                {
                                                    jobPresent.map((item, index) => (
                                                        <tr key={index} className='tabs-rows'>
                                                            <td>{item.jobName}</td>
                                                    ...
                                                    Object.entries(dataJob).map((item, index) => {
                                                        return item[1].status === indexStatus ?
                                                            < div className="item-box" key={index}>
                                                                ...
                                                                <h3 className='name-job'>{item[1].jobName}</h3>
                                                            </div>
                                                            :
                                                            ''
                                                    })
