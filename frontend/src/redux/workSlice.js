...
export const fetchWork = createAsyncThunk(
    'work/fetchWork', // tên action muốn fire
    async (userId) => {
        ...
        const response = await axios.post(`http://localhost:8080/api/getWorkUser`, { 'id': userId });
...
export const workSlide = createSlice({
    name: 'work',  // Tên của slice này là 'counter'
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchWork.fulfilled, (state, action) => { // gọi API thành công
